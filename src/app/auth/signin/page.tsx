...
const SignIn: React.FC = () => {
  return (
    <div>
      ...
      <header className="drop-shadow-1dark:drop-shadow-none sticky top-0 z-999 flex w-full bg-[#640F12]">
        <div className="flex flex-grow items-center justify-center px-4 py-4 shadow-2 md:px-6 2xl:px-11">
          <div className="flex items-center gap-8">
            <Image
              className=""
              src={"/images/nith/Logo.png"}
              alt="Logo"
              width={130}
              height={32}
            />
      ...
      <div className="m-8 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="m-auto text-center">
              <Image
                className="m-auto"
                src={"/images/nith/image 7.png"}
                alt="Logo"
                width={700}
                height={2}
              />
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-6">
                  ...
                  <Link href="/auth/signin/admin" className="text-blue-600">
                    Sign in as admin ?
                  </Link>
                </div>
